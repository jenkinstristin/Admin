...
$(document).ready(function(){
    ...
    function generateQATemplate(){
        jQuestions.append(
            ...
            "</div>"+
            "<div class='answer'>" +
            "A: <input type='text' id='answer1'>" +
            "</div>"+
			 "<div class='answer'>" +
            "B: <input type='text' id='answer2'>" +
            "</div>"+
			 "<div class='answer'>" +
            "C: <input type='text' id='answer3'>" +
            "</div>"+
			 "<div class='answer'>" +
            "D: <input type='text' id='answer4'>" +
            "</div>"+
			 "<div class='answer'>" +
            "E: <input type='text' id='answer5'>" +
            "</div>"+
    ...
    function addQuestion(){
		...
		$questionDiv.append(
		"<br><div class='submittedQs'><b>" + (questionCount+1) + ".)  " + questionName +":</b>" + space + "<input type='button' id='question"+questionCount+"' value='Edit'><br><br>");
		
		for(var i = 0; i < arrQuestion.length; i++) {
			$questionDiv.append(space, (i+1) +") " + arrQuestion[i]+"<br>");
		}
		$questionDiv.append("Answer: " + answer +"<br></div>");
